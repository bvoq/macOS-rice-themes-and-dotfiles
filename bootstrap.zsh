...
if [[ $OSTYPE == 'darwin'* ]] && isadmin; then
  ...
  if [ $GENERICTOOLS = 1 ]; then
    # essentials
    brew install bat copilot-cli direnv fnm fzf git gs jq mas ncdu nvim oath-toolkit rg starship tealdeer tmux trash tree zoxide yq yt-dlp watch zsh-completions
