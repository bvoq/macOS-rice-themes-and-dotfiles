...
phase_3_dotfiles() {
  link_dotfile "devops/.zshrc.d/00_safe_config.zsh" "$HOME/.zshrc.d/00_safe_config_devops.zsh"
  link_dotfile "devops/.zshrc.d/40_ishell_setup.zsh" "$HOME/.zshrc.d/40_ishell_setup_devops.zsh"
